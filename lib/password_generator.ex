defmodule PasswordGenerator do
  @moduledoc """
  Generates random password depending on parameters, Module main functions is 'generate(options)'
  ...
  ## Examples
      ...
      iez> PasswordGenerator.generate(options)
      "abcd3"
  ...
  defp validate_options_values_are_boolean(false, _length, _options) do
    {:error, "Only booleans are allowed as values"}
  end
